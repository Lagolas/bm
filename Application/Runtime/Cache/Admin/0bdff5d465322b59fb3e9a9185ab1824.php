				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                <form class="form-horizontal" role="form" id="validation-form" action="<?php echo U('index/updatemodel');?>" method="post">
                                	<input type="hidden" id="mid" name="mid" value="<?php echo ($model['mid']); ?>">
                                	<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="name"> 模型名称* </label>

										<div class="col-sm-9">
											<input type="text" id="name" name="name" value="<?php echo ($model['name']); ?>" placeholder="模型名称" class="col-xs-10 col-sm-5 limited" maxlength="25" />
										</div>
									</div>

									<div class="space-4"></div>
                                    <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="cname"> 模型别名(只读)* </label>

										<div class="col-sm-9">
											<input type="text" id="cname" value="<?php echo ($model['cname']); ?>" disabled class="col-xs-12 limited" maxlength="20" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<div class="radio">
                                                <label>
                                                    <input type="radio" name="state" value="1" <?php if($model['state']){ ?>checked<?php } ?> class="ace" />
                                                    <span class="lbl"> 开启</span>
                                                </label>&emsp;&emsp;
                                                <label>
                                                    <input type="radio" name="state" value="0" <?php if($model['state']==0){ ?>checked<?php } ?> class="ace" />
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control limited" name="remark" id="remark" maxlength="255"><?php echo ($model['remark']); ?></textarea>
										</div>
									</div>
