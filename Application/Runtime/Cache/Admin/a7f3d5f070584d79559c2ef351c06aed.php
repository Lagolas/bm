				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                <form class="form-horizontal" role="form" id="validation-form" action="<?php echo U('index/doeditpro');?>" method="post" enctype="multipart/form-data">
                                	...
                                	<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="title" name="title" class="col-xs-10 col-sm-5 limited" maxlength="25" value="<?php echo ($pro['title']); ?>" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" value="<?php echo ($pro['cname']); ?>" disabled class="col-xs-12" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
                                                ...
                                                <input class="form-control" type="text" value="<?php echo (date("m/d/Y",$pro['stime'])); ?> - <?php echo (date("m/d/Y",$pro['etime'])); ?>" name="setime" id="setime">
                                            </div>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control limited" name="description" id="description" maxlength="120"><?php echo ($pro['description']); ?></textarea>
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
                                        	...
                                        	<div class="space-4"></div>
                                            <input type="file" id="thumb" name="thumb" value="<?php echo ($pro['img']); ?>"/>
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
                                            ...
                                            <script id="editor" type="text/plain" style="width:100%;height:300px;"><?php echo ($pro['detail']); ?></script>
                                            <script type="text/javascript">
											//实例化编辑器
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control limited" name="remarks" id="remarks" maxlength="255"><?php echo ($pro['remarks']); ?></textarea>
										</div>
									</div>
                                    <div class="space-4"></div>
