				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="row">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                <form class="form-horizontal" role="form" id="validation-form" action="<?php echo U('index/doeditfield');?>" method="post">
                                	<input type="hidden" name="id" id="id" value="<?php echo ($field['id']); ?>">
                                    <input type="hidden" id="mid" value="<?php echo ($field['mid']); ?>">
                                	<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="name"> 字段名称* </label>

										<div class="col-sm-9">
											<input type="text" id="name" name="name" placeholder="字段名称，例如：姓名" value="<?php echo ($field['name']); ?>" class="col-xs-10 col-sm-5 limited" maxlength="25" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" disabled value="<?php echo ($field['cname']); ?>" class="col-xs-12" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<select class="form-control" id="type" disabled>
                                                <option><?php echo ($type[$field['type']]['name']); ?></option>
                                            </select>
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control" name="setting" id="setting"><?php echo ($field['setting']); ?></textarea>
                                            <div class="space-4"></div>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="pattern"> 校验规则 </label>
                                       	...
                                       	<div class="col-sm-6">
                                        	<input type="text" name="pattern" id="pattern" value="<?php echo ($field['pattern']); ?>" placeholder="正则表达式" class="col-xs-12">
                                        </div>
										<div class="col-sm-3">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="errormsg" name="errormsg" value="<?php echo ($field['errormsg']); ?>" placeholder="输入信息不符合设定规则时的提示信息，例如：邮箱格式错误" class="col-xs-12 limited" maxlength="25" />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="default" name="default" value="<?php echo ($field['default']); ?>" placeholder="字段的默认数据、预设数据" class="col-xs-12 limited" maxlength="120" />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="placeholder" name="placeholder" value="<?php echo ($field['placeholder']); ?>" placeholder="用来对用户起到提示作用，指引用户如何填写" class="col-xs-12 limited" maxlength="100" />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" id="listorder" name="listorder" class="col-xs-1" value="<?php echo ($field['listorder']); ?>"/>
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<div class="radio">
                                                <label>
                                                    <input type="radio" name="state" value="1" <?php if($field['state']){ ?> checked <?php } ?> class="ace" />
                                                    <span class="lbl"> 启用</span>
                                                </label>&emsp;&emsp;
                                                <label>
                                                    <input type="radio" name="state" value="0" <?php if($field['state']==0){ ?> checked <?php } ?> class="ace" />
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<div class="radio">
                                                <label>
                                                    <input type="radio" name="required" value="1" <?php if($field['required']){ ?> checked <?php } ?> class="ace" />
                                                    <span class="lbl"> 是</span>
                                                </label>&emsp;&emsp;
                                                <label>
                                                    <input type="radio" name="required" value="0" <?php if($field['required']==0){ ?> checked <?php } ?> class="ace" />
						...
						name:{
							...
							remote:{
								 ...
								 data:{
									 ...
									 origid:"id",
									 origidvalue:function(){return $('#id').val()}
								 }
							}
						},
